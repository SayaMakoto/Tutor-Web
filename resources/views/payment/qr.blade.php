@php
    ...
    $theme = $isTutor
        ? [
            'gradFrom' => 'from-green-600', 'gradTo' => 'to-emerald-600',
            'text'     => 'text-green-600', 'text700' => 'text-green-700',
            'bg50'     => 'bg-green-50',    'bg100'   => 'bg-green-100',
            'border'   => 'border-green-600', 'border200' => 'border-green-200',
            'btnHoverFrom' => 'hover:from-green-700', 'btnHoverTo' => 'hover:to-emerald-700',
            'qrDark'   => '#15803d',
        ]
        : [
            'gradFrom' => 'from-blue-600', 'gradTo' => 'to-indigo-600',
            'text'     => 'text-blue-600', 'text700' => 'text-blue-700',
            'bg50'     => 'bg-blue-50',    'bg100'   => 'bg-blue-100',
            'border'   => 'border-blue-600', 'border200' => 'border-blue-200',
...
<div class="max-w-lg mx-auto space-y-5">
    ...
    <div class="text-center">
        <div class="w-14 h-14 bg-gradient-to-br {{ $theme['gradFrom'] }} {{ $theme['gradTo'] }} rounded-2xl
        ...
        <div class="flex justify-center mb-4">
            <div class="relative p-3 border-4 {{ $theme['border'] }} rounded-2xl bg-white shadow-inner">
                ...
                <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div class="w-10 h-10 {{ $theme['gradFrom'] === 'from-green-600' ? 'bg-green-600' : 'bg-blue-600' }} rounded-lg flex items-center justify-center shadow-md">
    ...
    <div class="space-y-3">
        ...
        <form action="{{ route('payment.cancel') }}" method="POST">
            ...
            <input type="hidden" name="order_ref" value="{{ $order->order_ref }}">
            <button type="submit"
                    class="w-full text-gray-500 py-2 text-sm hover:text-red-600 transition">
                Hủy đơn và quay lại
            </button>
        </form>
    </div>
