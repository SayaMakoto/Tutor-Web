    ...
    <div class="max-w-lg">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
                ...
                <h2 class="font-bold text-gray-800">Thêm ngành học mới</h2>
            </div>

            <form action="{{ route('admin.grades.store') }}" method="POST" class="p-6 space-y-5">
                @csrf

                <div>
                    <label class="block text-xs font-semibold text-gray-500 mb-1.5">Tên ngành học <span
                            class="text-red-500">*</span></label>
                    <div class="relative">
                        <i
                            class="fas fa-layer-group absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400 text-sm pointer-events-none"></i>
                        <input type="text" name="name" value="{{ old('name') }}" required
                            placeholder="Ví dụ: Tiểu học, THCS, THPT,..."
                ...
                <div>
                    ...
                    <div class="relative">
                        <i
                            class="fas fa-sort-numeric-up absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400 text-sm pointer-events-none"></i>
                        <input type="number" name="sort_order" value="{{ old('sort_order') }}" placeholder="0"
                            class="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-xl text-sm
                                      focus:ring-2 focus:ring-violet-400 focus:border-transparent focus:outline-none">
                    </div>
                </div>
                ...
                <div class="flex justify-end gap-2 pt-2">
                    ...
                    <button type="submit"
                        ...
                        <i class="fas fa-save mr-1.5 text-xs"></i> Lưu ngành học
                    </button>
                </div>
            </form>
        </div>
