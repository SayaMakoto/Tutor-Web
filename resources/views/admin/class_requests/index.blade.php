...
@section('content')
    ...
    <div class="flex flex-wrap items-center justify-between gap-4 mb-6">
        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            <x-admin.search placeholder="Tìm theo mã, học viên, môn..." inputId="searchInput" />
                    ...
                    @forelse ($classRequests as $classRequest)
                        <tr class="hover:bg-gray-50/70 transition">
                            ...
                            <td class="px-5 py-3.5">
                                <span class="font-mono text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded-lg">#{{ $classRequest->id }}</span>
                            </td>
                            ...
                            <td class="px-5 py-3.5">
                                <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold {{ $classRequest->status_color }}">
                            ...
                            <td class="px-5 py-3.5">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <form action="{{ route('admin.class-requests.destroy', $classRequest->id) }}" method="POST"
                                          onsubmit="return confirm('Bạn chắc chắn muốn xoá lớp này?')">
                                        @csrf @method('DELETE')
                                        <button type="submit"
