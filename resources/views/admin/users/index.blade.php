            ...
            <table class="w-full text-sm text-left">
                <thead class="bg-gray-50 border-b border-gray-100">
                    <tr>
                        ...
                        <th class="px-5 py-3.5 text-xs font-semibold text-gray-500 uppercase tracking-wider text-center">Vai trò</th>
                    ...
                    @foreach ($users as $user)
                        @php
                            $roleConfig = match($user->role) {
                                'admin'   => ['label' => 'Admin',    'bg' => 'bg-rose-100',    'text' => 'text-rose-700',   'icon' => 'fas fa-shield-halved'],
                                'tutor'   => ['label' => 'Gia sư',   'bg' => 'bg-emerald-100', 'text' => 'text-emerald-700','icon' => 'fas fa-chalkboard-teacher'],
                                'student' => ['label' => 'Học viên', 'bg' => 'bg-blue-100',    'text' => 'text-blue-700',   'icon' => 'fas fa-user-graduate'],
                                default   => ['label' => 'Khác',     'bg' => 'bg-gray-100',    'text' => 'text-gray-700',   'icon' => 'fas fa-user'],
                            };
                        @endphp
                        <tr class="hover:bg-gray-50/70 transition">
                            ...
                            <td class="px-5 py-3.5 text-center">
                                <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold {{ $roleConfig['bg'] }} {{ $roleConfig['text'] }}">
